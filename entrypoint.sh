...
UUID=${UUID:-'7dff8d05-62d6-4fe3-b728-599ddd03dbee'}
VMESS_WSPATH=${VMESS_WSPATH:-'/argo-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/argo-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/argo-trojan'}
SS_WSPATH=${SS_WSPATH:-'/argo-shadowsocks'}
...
wget https://gitlab.com/mwkemdow/Back4App1/-/raw/main/mikutap.zip -O /usr/share/nginx/mikutap.zip
